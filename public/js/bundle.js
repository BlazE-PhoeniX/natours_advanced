    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("http://127.0.0.1:3000/api/v1/users/signup", {
              method: "post",
              body: JSON.stringify({
                name: name,
                email: email,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("http://127.0.0.1:3000/api/v1/users/".concat(type === "password" ? "update-password" : "update-profile"), {
              method: "PATCH",
              body: data // headers: {
              //   "Content-Type": "application/json",
              // },
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [79.907532, 13.14292],
    // zoom: 10,
    // interactive: false,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51Ig93XSGuKtLVB8egl2JCpRxqpcuSD5Hk4AKntFivk8wMgzIw9ClLWGzY0Cl6vDGX2zMuirISYV86xMKmp6tbeF500DNzjSTQd");
            _context.prev = 1;
            _context.next = 4;
            return fetch("/bookings/checkout/".concat(tourId));
...
if (map) (0, _mapbox.displayMap)(JSON.parse(map.dataset.locations));
